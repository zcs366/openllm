...
> 让 AI 从每次交互中学习、校准自身行为、选择性遗忘

---

## 1. 概述

OpenLLM 是一个 AI经验积累系统——一个能从交互经验中学习、据此校准自身行为、并选择性遗忘的系统。

> 🏛️ **历史里程碑**："造人不造工具"方向（2026-07-01 ~ 2026-07-08）已完成其历史使命。openLLM从"Agent躯体"进化为"经验积累系统"。
